...
(function () {
  ...
  function _arabicChar(value) {
    ...
    return arabicChars.reduce(
      (acc, char, index) =>
        acc.replace(new RegExp(char, "g"), persianChars[index]),
      value
    );
  }
  ...
  function _persianNumber(value) {
    ...
    return persianNumbers.reduce(
      (acc, number, index) =>
        acc.replace(new RegExp(number, "g"), englishNumbers[index]),
      value
    );
  }
  ...
  function _arabicNumber(value) {
    ...
    return arabicNumbers.reduce(
      (acc, number, index) =>
        acc.replace(new RegExp(number, "g"), persianNumbers[index]),
      value
    );
  }
